...
import { X, Bell, Check, Calendar, AlertTriangle, Flame, RotateCcw, ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm bg-white h-full shadow-2xl flex flex-col justify-between animate-in slide-in-from-right duration-200"
      >
        {/* Header */}
