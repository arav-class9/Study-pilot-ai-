  ...
  return (
    <div id="home-dashboard-page" className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-3">
            <div className="bg-white/10 backdrop-blur border border-white/15 rounded-2xl p-4 flex items-center gap-3 shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-3xl p-6 text-white shadow-md flex flex-col justify-between space-y-4 relative overflow-hidden">
        ...
        {lowestTopic ? (
          <>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs sm:text-sm px-5 py-3 rounded-2xl shadow-md shadow-rose-200 hover:shadow-lg transition-all shrink-0 cursor-pointer"
              >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              ...
              onClick={() => setActiveTab('practice')}
              className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs sm:text-sm px-5 py-3 rounded-2xl shadow-md shadow-indigo-200 hover:shadow-lg transition-all shrink-0 cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-5 sm:p-6 border border-slate-200 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <Clock className="w-5 h-5 text-indigo-600" />
              <h2 className="font-extrabold text-slate-900 text-base sm:text-lg">Today's Study Plan</h2>
            </div>
            <button
              onClick={() => setActiveTab('plan')}
          ...
          {dailyPlan.tasks.length === 0 ? (
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 text-center space-y-3">
              ...
              <p className="text-sm font-bold text-slate-700">No study plan tasks generated for today yet.</p>
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Generate an AI-powered study schedule tailored to your class, syllabus, and weak topics.
              </p>
              <button
                onClick={() => setActiveTab('plan')}
              ...
              {dailyPlan.tasks.map((task) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-bold text-indigo-600 uppercase bg-indigo-50 px-1.5 py-0.2 rounded">
                          {task.timeSlot}
                        </span>
                        <span className="text-xs font-semibold text-slate-500">
                          {task.subjectId.toUpperCase()} • {task.durationMinutes}m
                        </span>
                      </div>
                      <p className={`text-sm font-bold mt-0.5 ${task.completed ? 'text-slate-400' : 'text-slate-900'}`}>
